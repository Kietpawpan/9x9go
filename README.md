...
## Monteo Game Format:
Monteo Game Format (MGF) is a JavaScript code to create 9 x 9 Go diagram for game annotation, developed for commercial use in _The Art of 9 x 9 Go: Superhuman Edition_, by Monteo da Westi. 
