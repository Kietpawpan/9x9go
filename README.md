...
## Algorithm
1. Create a 9 x 9 Go board of 81 grid items displayed in the grid containner.
2. Each grid item has wood background. 
3. Create a Go stone in span, with black or white blackground.
4. Convert SGF moves to MGT moves, using string.replace. 
...
Wood image by 2happy<br>[https://www.stockvault.net/photo/124529/wood-background](https://www.stockvault.net/photo/124529/wood-background) 
